/* Есть четыре файла, которые заполнены числами от 1 до 100, от 1
...
int end=clock(); //запускаем время окончания
double t=(end-start); 
myfile4 << "Время выполнения работы программы: "<< t << endl;
...
int end=clock(); //запускаем время окончания
double t=(end-start); 
myfile6 << "Время работы программы в миллисекундах: "<< t<< endl;
...
int end=clock(); //запускаем время окончания
double t=(end-start);
myfile8 << "Время выпоолнения работы программы: "<< t << endl;
